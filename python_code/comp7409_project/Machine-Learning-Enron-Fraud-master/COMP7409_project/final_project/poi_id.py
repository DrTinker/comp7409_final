...
sys.path.append("../tools/")
from visualize import DrawPlot,draw_corr_matrix
...
DT_features_list_email = ['poi', 'exercised_stock_options', 'deferred_income']
...
# DrawPlot(my_dataset, 'salary', 'bonus')
# DrawPlot(my_dataset, 'long_term_incentive', 'exercised_stock_options')
# DrawPlot(my_dataset, 'exercised_stock_options', 'poi_email_ratio')
# DrawPlot(my_dataset, 'exercised_stock_options', 'total_stock_value')

# draw_corr_matrix(data_dict, features_list)
